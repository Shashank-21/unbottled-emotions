  ...
  return (
    <div className="flex flex-col bg-gradient-to-br from-pink-100 via-fuchsia-100 to-rose-100">
      ...
      <form
        ...
        className="flex flex-col items-center justify-around w-11/12 md:w-2/3 my-10 mx-auto p-5 md:p-10 bg-gradient-to-b from-stone-200 to-neutral-200 rounded-lg shadow-xl"
      >
